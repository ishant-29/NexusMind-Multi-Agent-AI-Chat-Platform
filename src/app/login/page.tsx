...
export default function LoginPage() {
  ...
  return (
    <AuthShell title="Welcome back" subtitle="Sign in to continue to NexusMind">
      {error && (
        <div
          role="alert"
      ...
      <p className="mt-8 text-center text-[13px] text-ink-secondary">
        New to NexusMind?{" "}
        <Link href="/signup" className="text-accent font-medium hover:text-accent-strong transition-colors">
          Create an account
        </Link>
      </p>
    </AuthShell>
